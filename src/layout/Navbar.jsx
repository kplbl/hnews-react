...
const Navbar = ({ setPage }) => {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between border-b-black py-0 border-b mb-2 mt-0 md:mt-4">
      ...
      >
        <div className="flex flex-col md:flex-row">
          <Link
            ...
            className={`navbar-link mb-0 py-2  px-2  border-b-4  ${
        ...
        <Link
          to="/login"
          className={`navbar-link mb-0 px-2  py-2 border-b-4  ${
